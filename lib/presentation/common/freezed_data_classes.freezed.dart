...
abstract class $LoginObjectCopyWith<$Res> {
  ...
  @useResult
  $Res call({String phone, String password, String fcm_token});
}
...
class _$LoginObjectImpl implements _LoginObject {
  _$LoginObjectImpl(this.phone, this.password, this.fcm_token);
  ...
  @override
  String toString() {
    return 'LoginObject(phone: $phone, password: $password, fcm_token: $fcm_token)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, phone, password, fcm_token);
...
abstract class _LoginObject implements LoginObject {
  factory _LoginObject(
          final String phone, final String password, final String fcm_token) =
      _$LoginObjectImpl;
